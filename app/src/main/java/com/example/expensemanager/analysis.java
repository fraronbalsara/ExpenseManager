...
public class analysis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.analysis_container, new daily()).commit();
        return v;
    }
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch(menuItem.getItemId()) {
                ...
                case R.id.monthly:
                    ...
                    break;
                case R.id.yearly:
                    selectedFragment = new yearly();
                    break;
            }
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.analysis_container, selectedFragment).commit();
            return true;
        }
    };
